...
class _SignUpViewState extends State<_SignUpView> {
  ...
  void _submit(BuildContext context) {
    ...
    final signUpData = {
      ...
      "local_district": _selectedCity!.name,
                              ...
                              children: [
                                Container(
                                  ...
                                  decoration: const BoxDecoration(
                                    image: DecorationImage(
                                      image:
                                          AssetImage('assets/logo_lexxi.png'),
                                      fit: BoxFit.contain,
                                    ),
                                  ),
                                  margin:
                              ...
                              children: [
                                ...
                                RoundedDropdownAndTextField<TypeDocument>(
                                  ...
                                  dropdownItemAsString:
                                      (TypeDocument typeDoc) => typeDoc.abrev,
                                ...
                                if (errorMessage != null)
                                  GestureDetector(
                                    onTap: () async {
                                      launchWhatsAppUri(
                                          '+573183491375',
                                          'El usuario con el correo: ${_emailController.text.trim()}, tiene el siguiente error: $errorMessage');
                                    },
                                    child: Column(
                                      children: [
                                        CircleAvatar(
